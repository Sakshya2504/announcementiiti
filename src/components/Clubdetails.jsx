...
function Individualclubpage() {
  ...
  const { clubName } = useParams(); // URL param: e.g., /club/Cynaptics
 ...
 <h1 className="text-3xl font-bold text-white text-center">Club Events</h1>
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {club.events.map((event, idx) => (
          <div key={idx} className="event-card p-4 bg-[#0f172a] text-white rounded-xl">
      ...
      <footer className="bg-[#01011b] py-10 text-white text-center">
        ...
        <a href={club.social.instagram}><img src="/images/Insta.png" alt="Instagram" /></a>
        <a href={club.social.linkedin}><img src="/images/linkedIn.png" alt="LinkedIn" /></a>
        <a href={club.social.facebook}><img src="/images/facebook.png" alt="Facebook" /></a>
      </footer>
    </>
  );
}
