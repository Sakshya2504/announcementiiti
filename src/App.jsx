    ...
    <div className="min-h-screen flex flex-col">
       <div className="container-fluid ">
            <div className="bg-gray-800 text-white hidden md:flex  gap-4 items-center top-0 py-8 "> 
                <p className="headingclass text-2xl items-center justify-center text-white "> Indian Institute of Technology Indore <br></br> भारतीय प्रौद्योगिकी संस्थान इंदौर  </p> 
             
               </div>
               
        <div className="md:hidden">
           <div className="bg-gray-800 text-white  top-0 py-10 "> 
          <p className="headingclass text-xl items-center text-white "> Indian Institute of Technology Indore<br></br> भारतीय प्रौद्योगिकी संस्थान इंदौर </p>
        </div>
        </div>
        </div>
     <Router>
