  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-black dark:bg-[#01011b] dark:text-white transition-colors duration-300">
      ...
      <Routes>
        ...
        <Route
          path="/signup"
          element={<Signup setissignup={setissignup} setpersoninfo={setpersoninfo} />}
        />
        <Route
          path="/login"
          element={<Login setissignup={setissignup} setpersoninfo={setpersoninfo} />}
        />
      ...
      <footer className="footer-container border-t border-[#3f3e45] w-full bg-[rgba(1,1,27)] text-white py-10 mt-auto">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="font-bold text-xl">
            Indian Institute of Technology Indore, <br /> Khandwa Road, Simrol, Indore 453552
          </p>
          ...
          <div className="flex justify-center gap-6 mt-4">
            ...
            >
              <img src={insta} alt="Instagram" className="h-7 w-7 hover:opacity-75" />
            </a>
            <a
              ...
              rel="noopener noreferrer"
            >
              <img src={linkedIn} alt="LinkedIn" className="h-7 w-7 hover:opacity-75" />
            </a>
            <a
              ...
              rel="noopener noreferrer"
            >
              <img src={twitter} alt="X" className="h-7 w-7 hover:opacity-75" />
            </a>
            <a
              ...
              rel="noopener noreferrer"
            >
              <img src={facebook} alt="Facebook" className="h-7 w-7 hover:opacity-75" />
            </a>
          </div>
